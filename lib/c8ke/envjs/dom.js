 ...
 */
    ...
    (function() {
       ...
       */
        ...
        NodeList.prototype = [];
        Envjs.extend(NodeList.prototype, {
            item: function(index) {
                var ret = null;
        ...
        Envjs.extend(Node.prototype, {
            ...
            importNode: function(importedNode, deep) {
                ...
                if (importedNode.nodeType == Node.ELEMENT_NODE) {
                    ...
                    // throw Exception if nodeType is not supported
   ...
   */
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(NamedNodeMap.prototype, {
            add: function(name) {
   ...
   */
    ...
    Envjs.extend(NamespaceNodeMap.prototype, {
        get xml() {
            var ret = "",
            ns,
            ind,
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(Namespace.prototype, {
            get value() {
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(CharacterData.prototype, {
            get data() {
                return this.nodeValue;
            },
            set data(data) {
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(CDATASection.prototype, {
            get nodeType() {
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(Comment.prototype, {
            get localName() {
                return null;
            },
            get nodeType() {
    ...
    (function() {
       ...
       */
        exports.DOMImplementation = DOMImplementation = function() {
            ...
            // by default, handle namespaces
            this.errorChecking = false;
            // by default, test for exceptions
        };

        Envjs.extend(DOMImplementation.prototype, {
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(Document.prototype, {
            ...
            get documentElement() {
                var i,
                length = this.childNodes ? this.childNodes.length: 0;
                for (i = 0; i < length; i++) {
   ...
   */
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(DocumentFragment.prototype, {
            get nodeType() {
    ...
    *****************************************************************************************************************/
      ...
      **/
        ...
        XMLP.prototype._parseAttribute = function(iB, iE) {
            ...
            this.m_cAlt = "";
            //resets the value so we don't use an old one by accident (see testAttribute7 in the test suite)
        ...
        function __parseLoop__(impl, doc, p) {
            ...
            while (true) {
                ...
                if (iEvt == XMLP._ELM_B) {
                    ...
                    pName = Envjs.trim(pName, true, true);
                    // strip spaces from Element name
                    ...
                    if (!impl.namespaceAware) {
                        ...
                        for (i = 0; i < p.getAttributeCount(); i++) {
                            ...
                            iAttr.value = p.getAttributeValue(i);
                            // set Attribute value
                        ...
                        for (i = 0; i < p.getAttributeCount(); i++) {
                            ...
                            if (__isNamespaceDeclaration__(strName)) {
                                ...
                                iNS.value = p.getAttributeValue(i);
                                // set value = namespaceURI
                                iNode._namespaces.setNamedItem(iNS);
                                // attach namespace to namespace collection
                            }
                            else {
                        ...
                        for (i = 0; i < iNode.attributes.length; i++) {
                            if (iNode.attributes.item(i).prefix != "") {
                                // attributes do not have a default namespace
                    ...
                    // attach Element to parentNode
                    iNodeParent = iNode;
                    // descend one level of the DOM Tree
                }

                else if (iEvt == XMLP._ELM_E) {
                    // End-Element Event
                    iNodeParent = iNodeParent.parentNode;
                    // ascend one level of the DOM Tree
                }
                    ...
                    if (iNodeParent.nodeType == Node.DOCUMENT_NODE) {
                        ...
                        // register this Element as the Document.documentElement
                    }
                    ...
                    // TextNode and entity Events
                    // get Text content
                    pContent = p.getContent().substring(p.getContentBegin(), p.getContentEnd());

                    if (!impl.preserveWhiteSpace) {
                        if (Envjs.trim(pContent, true, true) == "") {
                            pContent = "";
                            //this will cause us not to create the text node below
                        }
                    }
                    ...
                    if (!impl.preserveWhiteSpace) {
                        pContent = Envjs.trim(pContent, true, true);
                        // trim whitespace
                        pContent.replace(/ +/g, ' ');
                    ...
                    if (pContent.length > 0) {
                        // ignore empty CommentNodes
                        iNodeParent.appendChild(doc.createComment(pContent));
                        // attach Comment to parentNode
                    }
                }
                    ...
                    // no more events
                    if (iNodeParent == doc) {
                        // confirm that we have recursed back up to root
                        break;
                    }
                    else {
                        throw (new DOMException(DOMException.SYNTAX_ERR));
                        // one or more Tags were not closed properly
                    }
                    break;
       ...
       */
        ...
        Envjs.extend(DOMParser.prototype, {
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(Element.prototype, {
            ...
            getAttributeNS: function(namespaceURI, localName) {
                ...
                return ret;
                // if Attribute exists, return its value, otherwise return ""
            },
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(ProcessingInstruction.prototype, {
            get data() {
                return this.nodeValue;
            },
            set data(data) {
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(XMLSerializer.prototype, {
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(XPathResult.prototype, {
            get numberValue() {
        ...
        //navigator.appVersion.match(/MSIE 6.0/);
        ...
        */
        function xpathReduce(stack, ahead) {
            ...
            (ahead.tag.left && cand.prec >= ahead.prec))) {
                ...
                var matchexpr = mapExpr(cand.match,
                function(m) {
                    return m.expr;
                });
