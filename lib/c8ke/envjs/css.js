 ...
 */
    ...
    var __toDashed__ = function(camelCaseName) {
        if (camelCaseName) {
            return camelCaseName.replace(/[A-Z]/g,
            function(all) {
    ...
    (function() {
        ...
        Envjs.extend(CSS2Properties.prototype, {
            get cssText() {
                var i,
                css = [];
        ...
        var __addStyleAccessor__ = function(name) {
            if (name === 'width' || name === 'height') {
                CSS2Properties.prototype.__defineGetter__(name,
                function() {
            ...
            CSS2Properties.prototype.__defineSetter__(name,
            function(value) {
 ...
 */
        ...
        CSSRuleList = function(data) {
          log.debug("" + arguments.callee.caller)
            Envjs.setArray(this, data);
        };

        Envjs.extend(CSSRuleList.prototype, {
            item: function(index) {
 ...
 */
        ...
        Envjs.extend(StyleSheetList.prototype, {
            item: function(index) {
                if ((index >= 0) && (index < this.length)) {
                    // bounds check
                    return this[index];
 ...
 */
        ...
        Envjs.extend(HTMLElement.prototype, {
            get style() {
                if (!this.css2uuid) {
