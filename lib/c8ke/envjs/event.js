 ...
 */
     ...
     */
        ...
        Envjs.extend(Node.prototype, EventTarget.prototype);
    ...
    (function() {
       ...
       */
        ...
        Envjs.extend(UIEvent.prototype, {
            get view() {
                return this._view;
            },
            get detail() {
     ...
     */
        ...
        Envjs.extend(MouseEvent.prototype, {
            get screenX() {
     ...
     */
        ...
        Envjs.extend(KeyboardEvent.prototype, {
            ...
            initMouseEvent: function(type, bubbles, cancelable, windowObject, keyIdentifier, keyLocation, modifiersList, repeat) {
     ...
     */
        ...
        Envjs.extend(MutationEvent.prototype, {
            get relatedNode() {
   ...
   */
     ...
     */
        ...
        Envjs.extend(Document.prototype, DocumentEvent.prototype);
